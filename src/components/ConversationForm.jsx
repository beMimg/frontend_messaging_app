...
export default function ConversationForm({
  ...
  return (
    <div className="dark: flex w-full flex-row items-center gap-4  bg-gradient-to-br from-gray-100 to-gray-300  p-2 pl-5 dark:from-neutral-600 dark:to-neutral-800">
      <FaPlus />
      <form
